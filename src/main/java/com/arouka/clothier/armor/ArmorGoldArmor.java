...
public class ArmorGoldArmor extends ArmorClothier
{
    public ArmorGoldArmor(ArmorType armorType)
    {
        super(Names.Armor.GOLDARMOR_ARMOR, ArmorMaterialGoldArmor, armorType);
    }
    ...
    public String getArmorTexture(ItemStack armorStack, Entity entity, int armorSlot, String type)
    {
        if(armorStack.getItem() instanceof ArmorClothier)
        {
            ...
            {
                return Reference.MOD_ID.toLowerCase() + ":" + "textures/models/armor/goldarmorarmor_layer1.png";
            }
            else if (armorSlot == ArmorType.LEGS.ordinal())
            {
                return Reference.MOD_ID.toLowerCase() + ":" + "textures/models/armor/goldarmorarmor_layer2.png";
            }
        }
        return null;
    }
